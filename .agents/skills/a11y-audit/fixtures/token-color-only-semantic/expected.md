...
**Target**: /Users/colin/Sites/a11y-skill/.agents/skills/a11y-audit/fixtures/token-color-only-semantic/tokens.json
**Framework**: token
...
### 1. [WCAG 1.4.1] — Semantic token relies on color alone
**Location**: `/Users/colin/Sites/a11y-skill/.agents/skills/a11y-audit/fixtures/token-color-only-semantic/tokens.json:13`
**Blast radius**: design-system wide
**Issue**: Semantic token status-success communicates success using color alone. Provide a paired non-color cue such as text, iconography, or shape. Blast radius: design-system wide.
**Decision needed**: What non-color cue should accompany this semantic token across the design system?
**Current code**:
```
{"id": "status-success", "meaning": "success", "non_color_cue": false, "scope": "design-system", "token": "color.status.success"}
```
