...
## Snapshot
- Target: fixtures/tailwind-contrast-mapped
- Framework: react
...
**Location**: `fixtures/tailwind-contrast-mapped/Badge.tsx:5`
**Issue**: Tailwind class `text-red-300` likely fails WCAG AA contrast on light backgrounds.
**Fix**:
```diff
