...
Found **1** active findings: **1** safe to fix now, **0** need your decision. Also generated **8** guided checks for this target.

## Snapshot
- Target: fixtures/placeholder-single-quote
- Framework: html
...
**Location**: `fixtures/placeholder-single-quote/form.html:6`
...
+ <label for="contact-email-6">Email</label>
+ <input id="contact-email-6" type='email' name='contact_email' placeholder='Email'>
```
