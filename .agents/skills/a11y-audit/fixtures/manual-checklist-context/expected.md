...
No active findings. Generated **11** guided checks for this target — say "give me the checklist" to walk through them, or "save the baseline" to lock this clean run in.
...
## What to do next
- **Test it yourself:** say "give me the checklist" — 11 guided checks for this target.
...
#### 8. Overlay escape, trap, and focus return
**Capability**: `keyboard`
**WCAG**: 2.1.2, 2.4.3
...
#### 9. Form labels, errors, and required-state announcements
**Capability**: `screen reader`
...
#### 10. Dynamic status and validation announcements
**Capability**: `screen reader`
**WCAG**: 4.1.3
...
#### 11. SPA route change announcement and focus placement
**Capability**: `screen reader`
**WCAG**: 2.4.3, 4.1.3
