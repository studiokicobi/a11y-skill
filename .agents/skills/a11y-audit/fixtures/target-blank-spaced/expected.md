...
Found **2** active findings: **2** safe to fix now, **0** need your decision. Also generated **7** guided checks for this target.

## Snapshot
- Target: fixtures/target-blank-spaced
- Framework: html
...
## What to do next
- **Safe to fix now (2):** say "apply the safe fixes" and the agent will patch them.
...
**Location**: `fixtures/target-blank-spaced/links.html:5`
...
**Location**: `fixtures/target-blank-spaced/links.html:6`
**Issue**: target="_blank" without rel="noopener noreferrer". Security and sometimes accessibility issue.
**Fix**:
```diff
- <a href="https://other.test" target="_blank" rel="nofollow">
+ <a href="https://other.test" target="_blank" rel="nofollow noopener noreferrer">
```
