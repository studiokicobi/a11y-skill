...
**Target**: /Users/colin/Sites/a11y-skill/.agents/skills/a11y-audit/fixtures/token-focus-indicator/tokens.json
**Framework**: token
...
### 1. [WCAG 1.4.11] — Focus indicator token is missing or too weak
**Location**: `/Users/colin/Sites/a11y-skill/.agents/skills/a11y-audit/fixtures/token-focus-indicator/tokens.json:18`
**Blast radius**: one component (Button)
**Issue**: Focus indicator token button-ring is insufficient because focus-ring contrast is 1.54:1, below 3.0:1; focus-ring width is 1px, below 2px. Blast radius: one component (Button). Nearby compliant ring color: #949494.
**Decision needed**: Should we strengthen the focus ring color, width, or both for this token set?
**Current code**:
```
{"background": "color.surface.default", "component": "Button", "id": "button-ring", "scope": "component", "token": "color.focus.ring", "width_px": 1}
```
