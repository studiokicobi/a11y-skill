...
**Target**: http://example.test/checkout
**Framework**: unknown
**Standard**: WCAG 2.2 Level AA
**Date**: <DATE>

## Summary
Found 2 scanner-detected issues: **1 auto-fixable**, **1 need your input**, plus a manual checklist below. (0 scanner-flagged items require manual review.)
By source: runtime 2.
...
### 1. [WCAG 4.1.2] — aria-hidden on focusable element
**Location**: `http://example.test/checkout`
**Issue**: Focusable control is hidden from assistive technology.
**Fix**:
```diff
- <button data-source-file="src/components/CheckoutButton.tsx" data-source-line="42" data-source-column="7" aria-hidden="true">Pay</button>
+ <button data-source-file="src/components/CheckoutButton.tsx" data-source-line="42" data-source-column="7" >Pay</button>
```
...
**Current code**:
```
<span data-component-stack="Checkout > PriceBadge@src/components/PriceBadge.tsx:18">$9</span>
```
