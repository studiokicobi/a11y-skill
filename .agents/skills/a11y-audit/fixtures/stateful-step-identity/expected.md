...
Found **2** active findings: **0** safe to fix now, **2** need your decision. Also generated **9** guided checks for this target.
...
- Mode: triage
- Checked: runtime, stateful
- Findings by source: runtime 1, stateful 1
- Baseline: none
- Confidence: high 2
Artifacts:
- `triage-report.json`
...
- **Test it yourself:** say "give me the checklist" — 9 guided checks for this target.
